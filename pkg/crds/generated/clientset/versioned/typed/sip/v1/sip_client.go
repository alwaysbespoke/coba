...
func (c *SipV1Client) SIPCalls(namespace string) SIPCallInterface {
	return newSIPCalls(c, namespace)
}

func (c *SipV1Client) SIPMessages(namespace string) SIPMessageInterface {
	return newSIPMessages(c, namespace)
}

// NewForConfig creates a new SipV1Client for the given config.
...
// NewForConfigAndClient creates a new SipV1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SipV1Client, error) {
	...
	return &SipV1Client{client}, nil
}

// NewForConfigOrDie creates a new SipV1Client for the given config and
